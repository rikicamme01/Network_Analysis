...
const rows = [
    createData('Decisori', 63, 63, 100),
    createData('Gestionali', 84, 84, 100),
    createData('Operativi', 105, 105, 100),
    createData('TOT', 252, 252, 100),
];

export default function TabStatus100({ time }) {
    return (
        <div className='frame'>
